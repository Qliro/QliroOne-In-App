...
@property (nonatomic) NSTimeInterval loadTimeoutSeconds;
...
@interface QliroOneCheckout (SWIFT_EXTENSION(QliroOne)) <PKPaymentAuthorizationControllerDelegate>
...
/// Called when requesting an Apple Pay Payment
...
- (void)onClosePopup;
/// Called when an error occurs in the SDK (WebView failures, navigation errors, process termination, etc.)
/// \param code A machine-readable error code (e.g., “webview_terminated”, “navigation_failed”, “decode_error”)
///
/// \param message A human-readable error description
///
- (void)onErrorWithCode:(NSString * _Nonnull)code message:(NSString * _Nonnull)message;
/// Called when the SDK produces a log message. Use this to integrate SDK logging into your own logging system.
/// \param level The log level (“debug”, “info”, “warn”, “error”)
///
/// \param message The log message
///
- (void)onLogWithLevel:(NSString * _Nonnull)level message:(NSString * _Nonnull)message;
/// Called when the checkout state changes. Use this to build loading UIs or disable buttons at the right times.
/// \param state The new checkout state
///
/// \param previousState The previous checkout state
///
- (void)onStateChangedWithState:(NSString * _Nonnull)state previousState:(NSString * _Nonnull)previousState;
/// Called for lifecycle timing events. Use this to track checkout performance in your monitoring system.
